...
ALTER TABLE admin ADD UNIQUE KEY AdminID (AdminID);
ALTER TABLE bookapp ADD PRIMARY KEY (AppoID),
...
ALTER TABLE `donor` ADD PRIMARY KEY (`donarID`);


ALTER TABLE `feedback` ADD UNIQUE KEY `feedback_2` (`feedback`), ADD KEY `feedback` (`pID`);
ALTER TABLE `patients` ADD PRIMARY KEY (`UserID`);
ALTER TABLE `bookapp`MODIFY `AppoID` int(11) NOT NULL AUTO_INCREMENT;
ALTER TABLE `description` MODIFY `X` int(11) NOT NULL AUTO_INCREMENT;
ALTER TABLE `doctor` MODIFY `DoctorID` int(11) NOT NULL AUTO_INCREMENT;
ALTER TABLE `donor` MODIFY `donarID` int(11) NOT NULL AUTO_INCREMENT;
ALTER TABLE `patients`MODIFY `UserID` int(11) NOT NULL AUTO_INCREMENT;
ALTER TABLE `bookapp`
